...
let employeeUpdater = () => {
  employees = employees.filter(elem => elem.firstName === 'Theo'? false : true)
  employees = employees.filter(elem => elem.firstName === 'Lorie'? elem.department = 'HR' : null)
  return employees
}
...
//Code Here
var grumpyActivity = cat['catFriends'][0]['activities'][1];// bracket notation
var fluffy2ndFriend = cat.catFriends[1].name;//dot notation
